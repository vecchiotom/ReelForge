...
│       ├── Agents/                               # All 19 workflow agents (11 original + VideoStoryEditor + MotionGraphicsPlanner + VideoReviewAgent + MusicSupervisor + VideoEditDirector + MotionGraphicsDirector + Colorist + ColorGradeDirector)
