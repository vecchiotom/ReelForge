...
/// <summary>
/// Assembles all scene data, script, and Remotion components into a RenderManifest.
/// </summary>
public class AuthorAgentImpl : ReelForgeAgentBase
{
    ...
    public AuthorAgentImpl(IChatClient chatClient, IConfiguration configuration)
        : base(
            chatClient,
            configuration,
            "Author",
