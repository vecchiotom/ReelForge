...
public static class DatabaseSeeder
{
    ...
    private static string GetAvailableToolsJson(AgentType agentType)
    {
        ...
        // VideoEditDirector gets the identical minimal scope too: both its room-participant role
        // (a raw AIAgent built directly by EditRoomStepExecutor from these same tools) and its
        // standalone synthesis role only decide, never produce or touch media.
        if (agentType is AgentType.VideoStoryEditor or AgentType.VideoReviewAgent or AgentType.MusicSupervisor or AgentType.VideoEditDirector)
