...
public class ColorGradeRoomGroupChatManager : RoomGroupChatManager
{
    ...
    /// <param name="allParticipants">Seats in the same order as <see cref="ColorGradeRoomStepConfig.EffectiveSeats"/>, each participant registered twice and the director last (see the base constructor\'s remarks).</param>
