...
import {
  ...
  Table, ThemeIcon, Tooltip, Collapse,
} from '@mantine/core';
import { IconTrash, IconGitFork, IconX, IconRobot, IconChevronDown, IconChevronUp } from '@tabler/icons-react';
...
export const ParallelNode = memo(({ data }: { data: ParallelNodeData }) => {
  const { step, stepNumber, expanded, pinned, onExpandChange, onTogglePin, onChange, onRemove } = data;
      ...
      >
        <Card
          ...
          style={{
            ...
            background: 'linear-gradient(135deg, light-dark(#ffffff, var(--mantine-color-dark-7)) 0%, light-dark(#f0f9ff, var(--mantine-color-dark-6)) 100%)',
            cursor: 'pointer',
          }}
